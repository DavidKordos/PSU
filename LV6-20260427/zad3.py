...
# 2. Primjena hijerarhijskog grupiranja
# Metode koje isprobavam: 'single', 'complete', 'average', 'ward'
method = 'ward'
Z = linkage(X, method=method)

# 3. Prikaz dendrograma
plt.figure(figsize=(12, 7))
dendrogram(Z)
plt.title(f'Dendrogram (Metoda: {method})')
plt.xlabel('Indeksi uzoraka (ili veličina klastera)')
